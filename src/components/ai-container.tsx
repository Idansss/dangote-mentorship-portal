...
// AI output container (§19 §7 / Stitch redesign) — one consistent visual language
// for AI as a native citizen: an indigo spark, a soft indigo-tinted container,
// and an always-editable result the human confirms. Use this to wrap every AI
// surface (session summary, meeting prep, goal coach) so a suggestion always
// reads as a draft, visually distinct from committed (neutral) data. Indigo
// (`--info` #4F46E5 on a light tint) matches the Stitch "✨ AI Suggested" box.
...
export function AIContainer({
  ...
  return (
    <div
      className={cn('rounded-md border border-info/20 bg-info/[0.07] p-4', className)}
      {...props}
    >
